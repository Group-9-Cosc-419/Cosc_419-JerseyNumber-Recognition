# Weekly Combined Journal

# Week 1 (Feb 13 - Feb 21, 2026)

## Weekly Overview
This was the setup and proposal-direction week. The team built the repository and documentation workflow, started the shared Colab environment, reviewed relevant papers, and chose a proposal direction after comparing pipeline ideas in Meetings 1-4.

## Group Summary
The group established the initial working structure for the project and moved from familiarization to a selected pipeline direction. By the end of the week, proposal sections had been assigned and the team had a clearer sense of how much the baseline pipeline depended on shared GPU-backed execution.

## Weekly Task Table
| Task | Status | Evidence |
| :---- | :---- | :---- |
| Repository setup and review workflow | Done | Meetings 1 and 3; GitHub setup and branch-protection references |
| Shared proposal and journal structure | Done | Meeting 1 literature review tab; Meeting 2 documentation discussion |
| Shared Colab baseline setup | In Progress | Meeting 2 Colab workspace and SoccerNet import issue |
| Pipeline presentations and team vote | Done | Meetings 3 and 4 |

## Progress Since Last Week
This was the first recorded week, so the main progression was from no shared structure to a working collaboration model with assigned proposal work.

## Key Decisions
- Decision: Use a structured GitHub and document workflow.
  Reason: The team needed accountability and clear review rules.
  Impact: Repository controls, Kanban tracking, and shared documentation became standard.
- Decision: Use Colab as the shared execution path.
  Reason: Local machines were inconsistent for baseline replication.
  Impact: Early technical work centered around shared cloud runs.

## Challenges / Blockers
- Early Colab dependency issues, including SoccerNet import failures.
- Initial permission and project-tracking friction.
- Local setup instability across the team.

## Group Reflection
- What worked: Shared templates, recurring meetings, and clear role assignments.
- What didn't: Environment setup was slower than expected.
- What changed: The team moved from exploration to a selected proposal path.

## Individual Contributions

### Aaditya
**Current Tasks:** Repository setup, literature review, and proposal Sections 2 and 5.  
**Progress Update:** Repo workflow was completed; proposal drafting was in progress. Evidence: Meetings 1 and 3; Aaditya Week 1 log.  
**Contributions:** Set up GitHub controls, researched KfID and digit-wise ideas, and started the technical proposal sections.  
**Reflection:** What worked: early infrastructure setup. What didn't: local execution. What changed: moved from setup to shaping the technical direction.  
**Next Week Goals:** Finish assigned proposal sections and support final draft review.

### Leila
**Current Tasks:** Build shared documentation, help with literature review, and start the Colab baseline setup.  
**Progress Update:** Documentation structure and proposal materials were completed; Colab baseline setup remained in progress. Evidence: shared templates; Leila Week 1-2 table.  
**Contributions:** Created the shared proposal and journal structure, coordinated documentation, and supported literature review and presentation work.  
**Reflection:** What worked: documentation improved team coordination. What didn't: environment setup remained heavy. What changed: role expanded from organization to technical support.  
**Next Week Goals:** Finalize proposal work and continue the baseline setup.

### Enock
**Current Tasks:** Clone the shared repository, set up Colab, review related work, and support proposal writing.  
**Progress Update:** Repository and Kanban setup were completed; Colab replication remained in progress. Evidence: Enock contribution log; Meetings 1-3.  
**Contributions:** Created the shared repo workflow, set up project tracking, and pushed the baseline toward a runnable Colab configuration.  
**Reflection:** What worked: shared repository and Kanban setup. What didn't: dependency and GPU issues. What changed: moved from coordination into replication work.  
**Next Week Goals:** Finish assigned proposal sections and secure a reliable baseline run.

### Zhishang
**Current Tasks:** Download data, draft proposal sections, suggest a pipeline, and attempt a local run.  
**Progress Update:** Dataset and proposal work were completed; local execution remained unresolved. Evidence: Zhishang Week 1-2 table; project proposal document.  
**Contributions:** Downloaded SoccerNet, contributed proposal sections, and documented an alternate pipeline suggestion.  
**Reflection:** What worked: proposal writing and paper review. What didn't: local environment setup. What changed: gained a clearer understanding of the baseline pipeline structure.  
**Next Week Goals:** Continue local debugging and support proposal completion.

### Karo
**Current Tasks:** Review papers, draft proposal sections, and observe the baseline in Colab.  
**Progress Update:** Literature review and proposal work were completed; baseline execution remained in progress. Evidence: Karo task table and methodology notes.  
**Contributions:** Connected paper analysis to concrete design suggestions and helped draft the proposal's method discussion.  
**Reflection:** What worked: paper review translated into actionable design critique. What didn't: GPU limits slowed experiments. What changed: moved from research into method refinement.  
**Next Week Goals:** Finalize proposal sections and continue baseline validation.

# Week 2 (Feb 22 - Feb 28, 2026)

## Weekly Overview
This week focused on turning the proposal into a submission-ready draft while still collecting missing technical evidence. Meetings 5 and 6 were dominated by GPU access, proposal assembly, citations, formatting, and progress journal preparation.

## Group Summary
The team finished most assigned writing, used paid Colab access where needed, and treated proposal assembly and technical evidence collection as parallel tasks. The proposal moved from draft state to final review and submission preparation.

## Weekly Task Table
| Task | Status | Evidence |
| :---- | :---- | :---- |
| Finalize proposal sections | Done | Meetings 5 and 6 |
| Obtain missing baseline evidence | In Progress | Meeting 5 GPU issue discussion; Meeting 6 screenshots and Colab Pro accounts |
| Review citations and formatting | Done | Meeting 6 final draft cleanup |
| Compile the progress journal | Done | Meeting 6 journal compilation assignment |

## Progress Since Last Week
The team moved from proposal planning and section assignment to final drafting, technical validation, and submission preparation.

## Key Decisions
- Decision: Focus on obtaining real baseline outputs before final submission.
  Reason: Some sections depended on replication evidence.
  Impact: Technical runs and document editing proceeded side by side.
- Decision: Upgrade to Colab Pro where needed.
  Reason: Free GPU access was not enough for reliable runs.
  Impact: Paid cloud access became part of the workflow.

## Challenges / Blockers
- Late technical evidence still depended on reliable GPU access.
- Proposal assembly required citation and formatting fixes close to the deadline.

## Group Reflection
- What worked: Clear section ownership and fast review cycles.
- What didn't: Technical evidence still arrived late.
- What changed: The week shifted from writing to submission logistics.

## Individual Contributions

### Aaditya
**Current Tasks:** Finish Sections 2 and 5 and help unify the draft.  
**Progress Update:** Sections 2 and 5 were completed; cross-review was in progress. Evidence: Aaditya Week 2 table.  
**Contributions:** Finished assigned writing and helped refine the full proposal draft.  
**Reflection:** What worked: early section completion. What didn't: reliance on late technical results. What changed: moved into peer review.  
**Next Week Goals:** Transition into implementation work after submission.

### Leila
**Current Tasks:** Finalize proposal sections, maintain logs, and continue the baseline setup.  
**Progress Update:** Proposal support and documentation were completed; baseline execution remained in progress. Evidence: Leila Week 1-2 table.  
**Contributions:** Helped package the proposal, maintained meeting and reflection structure, and kept the team coordinated.  
**Reflection:** What worked: structured documentation. What didn't: baseline execution still lagged. What changed: moved toward final submission support.  
**Next Week Goals:** Help verify the baseline and begin implementation planning.

### Enock
**Current Tasks:** Finish Sections 2.2 and 5.1 and keep the baseline work moving.  
**Progress Update:** Proposal sections and Colab-based pipeline observation were completed; GPU access was upgraded. Evidence: Enock second contribution log.  
**Contributions:** Finished proposal sections and secured stronger GPU support for future runs.  
**Reflection:** What worked: paid GPU access improved continuity. What didn't: the pipeline remained resource-heavy. What changed: moved from setup into usable baseline evidence collection.  
**Next Week Goals:** Reproduce the baseline cleanly and support Top-K planning.

### Zhishang
**Current Tasks:** Continue proposal work and local environment troubleshooting.  
**Progress Update:** Proposal support continued; no separate week-specific execution result was recorded. Evidence: Zhishang combined Week 1-2 entry.  
**Contributions:** Continued proposal support and local debugging.  
**Reflection:** What worked: proposal writing remained productive. What didn't: environment issues persisted. What changed: no separate week-specific change was recorded.  
**Next Week Goals:** Resume technical work after proposal submission.

### Karo
**Current Tasks:** Finalize assigned proposal sections and keep reviewing the baseline pipeline.  
**Progress Update:** Proposal writing was completed; baseline execution remained in progress. Evidence: Karo opening task table.  
**Contributions:** Supported final proposal refinement and method-level discussion.  
**Reflection:** What worked: proposal writing stayed aligned with the reviewed papers. What didn't: experimental work was still constrained. What changed: moved closer to implementation-oriented review.  
**Next Week Goals:** Shift from proposal support to code and experiment planning.

# Week 3 (Mar 1 - Mar 7, 2026)

## Weekly Overview
This was the baseline validation week. The group confirmed the 87.12 percent reference result, compared local and shared execution attempts, and decided that Top-K frame filtering would be the first implementation target.

## Group Summary
Baseline replication gave the project a stable control result, and the team used that result to identify where time and noise were being wasted in the current pipeline. The focus narrowed from general improvement ideas to a concrete Top-K intervention.

## Weekly Task Table
| Task | Status | Evidence |
| :---- | :---- | :---- |
| Confirm the baseline accuracy | Done | Meeting 7 result summary |
| Compare local and cloud execution reliability | Done | Meeting 7 local-vs-Colab notes |
| Select the next improvement target | Done | Meeting 7 Top-K planning discussion |

## Progress Since Last Week
The work shifted from proposal completion to measurable baseline replication and post-baseline planning.

## Key Decisions
- Decision: Use 87.12 percent as the baseline control.
  Reason: Multiple Colab runs matched.
  Impact: Later experiments gained a stable benchmark.
- Decision: Prioritize Top-K next.
  Reason: PARSeq was the biggest runtime bottleneck and low-legibility frames were clear noise sources.
  Impact: The team started drafting Top-K implementation plans.

## Challenges / Blockers
- Local machines were still unreliable for full-pipeline runs.
- The team needed a low-risk intervention that would not break the existing stage interfaces.

## Group Reflection
- What worked: Independent replication built trust in the baseline.
- What didn't: Local execution still lagged behind Colab.
- What changed: The team moved from replication to targeted improvement planning.

## Individual Contributions

### Aaditya
**Current Tasks:** Evaluate the baseline and analyze its errors.  
**Progress Update:** Baseline execution, error analysis, and Top-K/multi-task concept work were completed. Evidence: Aaditya Week 3 table.  
**Contributions:** Identified 1-vs-2 digit confusion as a major failure mode and proposed Top-K plus multi-task follow-up ideas.  
**Reflection:** What worked: concrete error analysis. What didn't: flat-class modeling looked structurally limited. What changed: moved into diagnosis and redesign thinking.  
**Next Week Goals:** Implement the Top-K branch.

### Leila
**Current Tasks:** No project work recorded this week.  
**Progress Update:** No project activity. Evidence: Leila Week 3 note.  
**Contributions:** No work was completed on the project during this period because other academic obligations took priority. The project was between proposal submission and Top-K execution, so this week functioned as a pause rather than a loss of project direction.  
**Reflection:** What worked: the earlier weeks had created a stable enough foundation that the project could tolerate a short pause. What didn't: overlapping deadlines prevented active contribution. What changed: Leila deliberately planned to re-engage by Meeting 7 and return directly into the Top-K phase.  
**Next Week Goals:** Rejoin meetings and the Top-K phase.

### Enock
**Current Tasks:** Independently reproduce the baseline.  
**Progress Update:** Independent baseline replication was completed. Evidence: Meeting 7 confirmed 87.12 percent result.  
**Contributions:** Matched the baseline accuracy and strengthened reproducibility.  
**Reflection:** What worked: the Colab-based pipeline reproduced the control result. What didn't: it still depended on cloud GPU access. What changed: moved into validated experimentation.  
**Next Week Goals:** Start Top-K experimentation.

### Zhishang
**Current Tasks:** No project work recorded this week.  
**Progress Update:** No project activity. Evidence: Zhishang Week 3 note.  
**Contributions:** No project work recorded.  
**Reflection:** What worked: no specific update recorded. What didn't: no active progress this week. What changed: planned return in Week 4.  
**Next Week Goals:** Support Top-K code planning.

### Karo
**Current Tasks:** Audit the code path needed for Top-K.  
**Progress Update:** The `main.py` trace and raw-score compatibility check were completed. Evidence: Karo Week Mar 2 - Mar 8 note.  
**Contributions:** Verified that raw legibility scores could support a filtering stage and that the pipeline had a feasible insertion point.  
**Reflection:** What worked: interface auditing reduced ambiguity. What didn't: implementation still depended on other moving parts. What changed: moved from literature work into direct code-path validation.  
**Next Week Goals:** Support Top-K integration and compatibility checks.

# Week 4 (Mar 8 - Mar 15, 2026)

## Weekly Overview
This week defined and started the Top-K implementation. The team chose legibility-score sorting over KFA-ID, pinned the insertion point in `main.py`, and assigned both implementation and K-sweep responsibilities.

## Group Summary
The team went from proposal-style planning to concrete engineering work on Top-K. The solution was intentionally scoped as a thin change that reused the existing legibility classifier and minimized downstream breakage.

## Weekly Task Table
| Task | Status | Evidence |
| :---- | :---- | :---- |
| Choose the Top-K strategy | Done | Meetings 8 and 9 |
| Define insertion point in `main.py` | Done | Meeting 8 plan: between legibility and pose |
| Assign K-sweep roles and environment workflow | Done | Meetings 8-10 |

## Progress Since Last Week
The team moved from "Top-K should be explored" to "Top-K should be implemented in this specific place with these K values and owners."

## Key Decisions
- Decision: Use legibility-score-based Top-K instead of KFA-ID.
  Reason: Lower implementation risk and no extra network.
  Impact: Reused existing model outputs and simplified integration.
- Decision: Filter before pose detection.
  Reason: Remove noisy frames before expensive downstream stages.
  Impact: Lowered the number of frames entering pose and PARSeq.

## Challenges / Blockers
- Needed exact alignment between raw score order and downstream frame lists.
- Heavy runs still depended on limited GPU access.

## Group Reflection
- What worked: The team converged quickly once the solution space was narrowed.
- What didn't: Environment and integration dependencies still created delay.
- What changed: The work shifted from planning to implementation.

## Individual Contributions

### Aaditya
**Current Tasks:** Build the Top-K branch and wire it into `main.py`.  
**Progress Update:** Top-K branch, filtering logic, and `main.py` integration were completed; a 91.71 percent mock validation was recorded. Evidence: Aaditya Week 4 table; `main.py`.  
**Contributions:** Implemented the first concrete Top-K code path and validated it in isolation.  
**Reflection:** What worked: isolated validation. What didn't: full-pipeline proof was still pending. What changed: moved into direct implementation.  
**Next Week Goals:** Start multi-task planning and data-layer changes.

### Leila
**Current Tasks:** Finalize the Top-K plan, lock the environment, and prepare K-sweep runs.  
**Progress Update:** Meetings 7-9 participation and environment validation were completed; K=5/K=7 ownership and notebook refactoring remained in progress. Evidence: Leila Week 4 table.  
**Contributions:** Helped turn Top-K from a proposal into an executable plan by attending Meetings 7-9, contributing a detailed implementation proposal, validating the Colab Pro+ environment, and taking ownership of High-Compute Run B at K=5 and K=7. She also kept refactoring the shared notebooks so the pipeline would remain reproducible as new Top-K components were added.  
**Reflection:** What worked: rapid meetings and clear role assignments let the team converge quickly after the blank week. What didn't: GPU coordination and environment maintenance still required constant work. What changed: Leila moved from proposal coordination into direct experiment ownership and environment stewardship.  
**Next Week Goals:** Execute the assigned K-sweep runs.

### Enock
**Current Tasks:** Begin Top-K experiments and debug consistency.  
**Progress Update:** Top-K experimentation and debugging were in progress. Evidence: Enock Top-K log; `main.py`; `helpers.py`.  
**Contributions:** Carried the baseline into the Top-K phase and started tracing the consistency issue.  
**Reflection:** What worked: the baseline comparison point was clear. What didn't: K values were not yet producing reliable distinctions. What changed: moved into experiment debugging.  
**Next Week Goals:** Document and debug the K-value behavior.

### Zhishang
**Current Tasks:** Learn the Top-K code path and draft an implementation.  
**Progress Update:** Top-K planning and code-structure review were completed. Evidence: Zhishang Week 4 entry.  
**Contributions:** Studied the legibility stage and located where Top-K logic should attach.  
**Reflection:** What worked: code reading clarified the intervention point. What didn't: tensor-shape reasoning remained hard. What changed: moved from general familiarity to implementation-specific understanding.  
**Next Week Goals:** Help apply the Top-K logic.

### Karo
**Current Tasks:** Validate aggregation compatibility and debug K-value issues.  
**Progress Update:** Compatibility validation and parameter-debugging support were completed. Evidence: Karo Week Mar 9 - Mar 15 note; `helpers.py`; `main.py`.  
**Contributions:** Ensured that the filtered output could still feed the confidence-weighted aggregation stage.  
**Reflection:** What worked: interface validation prevented false conclusions. What didn't: bugs still spanned multiple scripts. What changed: moved deeper into evaluation correctness work.  
**Next Week Goals:** Support K-sweep analysis and the next architecture step.

# Week 5 (Mar 16 - Mar 22, 2026)

## Weekly Overview
This week combined Top-K result follow-up with planning for the next architecture change. The group kept collecting and validating K-sweep evidence while several members started laying groundwork for a multi-task classifier path.

## Group Summary
Top-K was no longer just an implementation task; it became an interpretation problem because of result consistency concerns. At the same time, the team started designing the next branch so progress would not stall if Top-K alone proved insufficient.

## Weekly Task Table
| Task | Status | Evidence |
| :---- | :---- | :---- |
| Run and compare Top-K variants | In Progress | Meeting 11 follow-up; Top-K results in individual logs |
| Validate result consistency across members | In Progress | Leila Week 5 discrepancy note; Enock Top-K debugging |
| Plan the next pipeline stage | Done | Meeting 11 planning discussion |

## Progress Since Last Week
The project progressed from implementation-ready Top-K work to actual experiment review, debugging, and next-step architecture planning.

## Key Decisions
- Decision: Continue validating Top-K instead of locking a final claim too early.
  Reason: Reported gains were not yet fully consistent across runs.
  Impact: Debugging and integration testing continued through the week.
- Decision: Begin the multi-task branch in parallel.
  Reason: The team needed another path to address 1-vs-2 digit confusion if Top-K plateaued.
  Impact: Data-layer and architecture work started before Top-K was fully settled.

## Challenges / Blockers
- Top-K accuracy claims were not yet consistent across environments.
- The team needed traceable evidence before finalizing the ablation story.

## Group Reflection
- What worked: The team kept moving by pairing result validation with next-stage planning.
- What didn't: Top-K outputs still needed reconciliation.
- What changed: The project expanded from one intervention to two parallel improvement paths.

## Individual Contributions

### Aaditya
**Current Tasks:** Plan and build the multi-task classifier path.  
**Progress Update:** Multi-task planning, label splitting, and shared-backbone training work were completed. Evidence: Aaditya Week 5 table; `jersey_number_dataset.py`.  
**Contributions:** Designed the multi-task branch and rewrote the data representation needed to train it.  
**Reflection:** What worked: label splitting and shared-head planning. What didn't: the new path still needed end-to-end proof. What changed: moved from Top-K filtering to classifier redesign.  
**Next Week Goals:** Diagnose performance and support final report work.

### Leila
**Current Tasks:** Run K=5 and K=7, keep notebooks aligned, and validate outputs.  
**Progress Update:** K-sweep execution and integration testing were in progress; result discrepancy flagging was completed. Evidence: Leila Week 5 table; Colab Pro+ outputs.  
**Contributions:** Took on the role of continuous pipeline integrator by rerunning the full SoccerNet pipeline after teammate code changes, validating output JSON formats, and using Colab Pro+ to execute the K=5 and K=7 runs. She also identified the discrepancy between Enock's reported Top-K result and her independently verified outputs, which prevented the team from accepting an unverified gain.  
**Reflection:** What worked: having one reliable integration environment improved comparability and shortened the validation loop. What didn't: the discrepancy with Enock's Top-K result delayed the ablation story and required more reruns. What changed: Leila became the de facto integration lead for the Top-K phase.  
**Next Week Goals:** Consolidate verified K-sweep results and pivot into multi-task work.

### Enock
**Current Tasks:** Continue Top-K runs and debug `main.py` and `helpers.py`.  
**Progress Update:** Top-K result logging and parameter debugging were completed. Evidence: Enock Top-K log; `main.py`; `helpers.py`.  
**Contributions:** Reported the best observed K result and traced the earlier identical-output issue back to implementation details.  
**Reflection:** What worked: debugging turned a confusing symptom into an engineering issue. What didn't: the results still required independent verification. What changed: moved from runner to debugger.  
**Next Week Goals:** Resolve remaining consistency issues and finalize the interpretation.

### Zhishang
**Current Tasks:** Apply Top-K with a custom image-loading path.  
**Progress Update:** Top-K code creation and a custom image loader were completed. Evidence: Zhishang Week 5 note.  
**Contributions:** Added code support for filtering images based on the legibility classifier and loading them into the next step.  
**Reflection:** What worked: the custom loader made the filtered image path explicit. What didn't: no validated final result was recorded for this branch. What changed: moved from planning to actual code creation.  
**Next Week Goals:** Continue implementation support.

### Karo
**Current Tasks:** Transition the multi-task data layer and keep work isolated.  
**Progress Update:** Label splitting and async workflow support were completed. Evidence: Karo Week Mar 16 - Mar 22 note; `jersey_number_dataset.py`.  
**Contributions:** Owned the data-layer changes needed for the multi-task branch.  
**Reflection:** What worked: clear input/output boundaries. What didn't: the rest of the branch still needed end-to-end validation. What changed: moved from Top-K compatibility to multi-task data foundations.  
**Next Week Goals:** Support aggregation and validation for the multi-task path.

# Week 6 (Mar 23 - Mar 30, 2026)

## Weekly Overview
This week centered on final consolidation, reporting, and multi-task diagnosis. The group discussed why Top-K and multi-task accuracy were inconsistent, cleaned up journal and presentation work, and documented the strongest evidence and limitations for the final deliverables.

## Group Summary
The project entered its close-out phase. The group kept discussing unresolved accuracy issues, but the emphasis moved toward evidence-backed reporting, presentation prep, branch review, and clear final documentation.

## Weekly Task Table
| Task | Status | Evidence |
| :---- | :---- | :---- |
| Review Top-K and multi-task accuracy issues | Done | Meetings 12-14 |
| Draft and review the progress journal | Done | Meeting 12 and Meeting 13 assignments |
| Prepare presentation materials | In Progress | Meeting 13 Canva assignments; Meeting 14 final implementation updates |
| Consolidate final implementation notes | In Progress | Meeting 14 team update request |

## Progress Since Last Week
The work shifted from active experiment iteration to packaging, diagnosis, and presentation-ready documentation.

## Key Decisions
- Decision: Be explicit about unresolved accuracy limitations.
  Reason: Top-K and multi-task results were not consistently outperforming the baseline.
  Impact: The final story had to balance attempted improvements with honest limitations.
- Decision: Split final deliverables across journal, presentation, and cleanup tasks.
  Reason: Time pressure now affected both technical and reporting work.
  Impact: The week became strongly coordination-driven.

## Challenges / Blockers
- Accuracy improvements remained inconsistent late in the project.
- Final deliverables had to be completed while interpretation was still evolving.

## Group Reflection
- What worked: Frequent meetings kept ownership and deadlines visible.
- What didn't: The improvement story remained technically messy.
- What changed: The focus moved from building to documenting and presenting.

## Individual Contributions

### Aaditya
**Current Tasks:** Evaluate the multi-task model, write report content, and help finalize delivery materials.  
**Progress Update:** Multi-task evaluation and report drafting were in progress; presentation logistics were completed. Evidence: Aaditya Week 6 table; COM 109 booking.  
**Contributions:** Diagnosed crop mismatch as a major issue for the multi-task branch and supported the final report and presentation workflow.  
**Reflection:** What worked: failure analysis identified a concrete cause. What didn't: evaluation performance on rough crops remained poor. What changed: moved into diagnosis and final packaging.  
**Next Week Goals:** Finalize the report, presentation, and journal.

### Leila
**Current Tasks:** Stabilize the multi-task environment and compare crop variants.  
**Progress Update:** Environment, automation, integration, and crop-result analysis were completed. Evidence: `setup_env.sh`, `RUN_ORDER.md`, `recognition_multitask.py`, and recorded crop outputs.  
**Contributions:** Converted the `leila-multitask-setup` branch into a reproducible experimentation environment by creating setup, download, run-order, and end-to-end automation scripts, fixing the dataset loader and training path, aligning inference outputs with the PaRSeq JSON format, and running full-body, center-crop, and pose-crop experiments. This work showed that preprocessing mismatch, not only the architecture itself, explained the weak multi-task results.  
**Reflection:** What worked: the branch became reproducible, well organized, and diagnostically useful despite poor early accuracy. What didn't: the multi-task path still underperformed the baseline because of crop mismatch and environment friction. What changed: Leila moved from Top-K integration into full multi-task branch ownership and reproducibility engineering.  
**Next Week Goals:** Retrain on pose-based crops and support final ablation reporting.

### Enock
**Current Tasks:** No separate week-specific task list was recorded.  
**Progress Update:** No separate Week 6 entry was recorded for Enock. Evidence: group-level finalization in Meetings 12-14 only.  
**Contributions:** No distinct Week 6 individual contribution was preserved beyond team-level finalization work.  
**Reflection:** What worked: team-level deliverable roles were explicit. What didn't: no week-specific Enock narrative was preserved. What changed: the record shifted from individual logs to group meetings.  
**Next Week Goals:** Support final presentation and close-out work.

### Zhishang
**Current Tasks:** No separate week-specific task list was recorded.  
**Progress Update:** No separate Week 6 entry was recorded for Zhishang. Evidence: group-level meeting records only.  
**Contributions:** No distinct Week 6 individual contribution was preserved beyond team-level presentation and finalization support.  
**Reflection:** What worked: group coordination continued. What didn't: no separate individual Week 6 source note survived. What changed: the evidence became group-level rather than person-level.  
**Next Week Goals:** Support final presentation and close-out work.

### Karo
**Current Tasks:** Integrate aggregation logic for the multi-task path and validate tie-breaking.  
**Progress Update:** Aggregation integration and system validation were completed. Evidence: Karo Week Mar 23 - Mar 29 task list.  
**Contributions:** Finalized the aggregation-side compatibility needed for the multi-head output.  
**Reflection:** What worked: the multi-task output remained compatible with the final decision layer. What didn't: the source notes include little extra reflection for this week. What changed: moved fully into integration and validation work.  
**Next Week Goals:** Support final reporting and presentation work.
...
* We discussed the challenges we are facing for improving accuracy, and speed.
* Proposed the better way to improve the accuracy and having consistency accuracy  
* We discussed what will do for presentation and live demo 
* We discussed the presentations, github and progress journal
...
* Everyone : provide personal reflections  
* Everyone: provide updates for final implementations
* Leila and Enock: Final github cleanup and pipeline implmentation
* Karo and Zhishang: Canva presentation
* Aaditya: Progress journal and canva presentation
